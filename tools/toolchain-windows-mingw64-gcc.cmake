...
if(DEFINED ENV{MSYS2_LOCATION} AND NOT "$ENV{MSYS2_LOCATION}" STREQUAL "")
    file(TO_CMAKE_PATH "$ENV{MSYS2_LOCATION}" MSYS2_ROOT)
    set(TOOLCHAIN_PREFIX "${MSYS2_ROOT}/ucrt64")
else()
...
if(NOT DEFINED ENV{BUILD_TARGET} OR "$ENV{BUILD_TARGET}" STREQUAL "")
    set(ENV{BUILD_TARGET} "mingw64")
    message(STATUS "BUILD_TARGET defaulting to mingw64 (MinGW toolchain)")
endif()
